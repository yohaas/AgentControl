...
- [pending] Add a read-only File Explorer tile, dock, and popout for browsing files, recursive search, raw/formatted markup previews, diffs, terminal docking, and sending project context to chats
