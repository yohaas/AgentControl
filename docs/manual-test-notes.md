...
1. Open a project that is a Git repository in AgentHero.
...
4. Confirm the descendant worktree shows `Inside project` and an enabled `Open & Switch` button when it is not already an AgentHero project.
5. Click `Open & Switch`.
