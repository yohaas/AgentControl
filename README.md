...
- Use `/mobile` for a phone-first view of existing chats in the selected project, with a collapsible left nav, project switcher, transcript viewer, status indicators, stop control, and message sending.
