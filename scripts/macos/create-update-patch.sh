...
copy_path "scripts/windows/start-installed-agent-hero.ps1"
copy_path "scripts/windows/start-installed-update.ps1"
copy_path "scripts/windows/update-installed-agent-hero.ps1"
copy_path "assets"
