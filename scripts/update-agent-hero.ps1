...
$logPath = Join-Path $env:TEMP "agent-hero-update.log"
...
Write-UpdateLog "AgentHero update started in $repoRoot"
...
Write-UpdateLog ""
Write-UpdateLog "AgentHero update complete."
Write-UpdateLog "Wait 30 seconds and refresh AgentHero."
